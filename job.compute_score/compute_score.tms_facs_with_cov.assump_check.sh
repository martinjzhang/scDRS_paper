...
#SBATCH --array=0-10         # Memory pool for all cores (see also --mem-per-cpu)
...
# Binary
GS_FILE=/n/holystore01/LABS/price_lab/Users/mjzhang/scDRS_data/gs_file/assump_check.rv1.gs.batch/batch$BATCH_NUM.gs
OUT_FOLDER=/n/holystore01/LABS/price_lab/Users/mjzhang/scDRS_data/score_file/score.tms_facs_with_cov.assump_check
