...
#SBATCH --array=4          # Memory pool for all cores (see also --mem-per-cpu)
...
OUT_FOLDER=/n/holystore01/LABS/price_lab/Users/mjzhang/scTRS_data/score_file/score.tms_facs_with_cov.magma_10kb_1000.with_raw_ctrl
